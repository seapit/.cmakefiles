...
function(LIB LIB_NAME LIB_TYPE USE_C USE_GEN)
  ...
  if(USE_GEN)
    file(GLOB_RECURSE GENERATED_SOURCES
         "${CMAKE_CURRENT_LIST_DIR}/generated/*.cpp")
  ...
  if(${LIB_NAME}_TYPE STREQUAL "STATIC")
    ...
    target_compile_options(
      ${LIB_NAME} PRIVATE $<$<CONFIG:Debug>:${CMAKE_CXX_FLAGS_DEBUG}>
  ...
  elseif(${LIB_NAME}_TYPE STREQUAL "SHARED")
    ...
    target_compile_options(
      ${LIB_NAME} PUBLIC $<$<CONFIG:Debug>:${CMAKE_CXX_FLAGS_DEBUG}>
                         $<$<CONFIG:Release>:${CMAKE_CXX_FLAGS_RELEASE}>)
  ...
  elseif(${LIB_NAME}_TYPE STREQUAL "MODULE")
    ...
    target_compile_options(
      ${LIB_NAME} INTERFACE $<$<CONFIG:Debug>:${CMAKE_CXX_FLAGS_DEBUG}>
                            $<$<CONFIG:Release>:${CMAKE_CXX_FLAGS_RELEASE}>)
  endif()
